<template>
    <button :id="`button-${id}`" class="rounded-lg shadow w-36 h-36 mx-auto">
        <img :id="`first-${id}`" src="" alt="Tutor photo" class="rounded-lg hover:scale-110 transition">
    </button>
        ...
        <div class="relative p-4 w-full max-w-lg h-full md:h-auto">
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 md:p-8">
                ...
                <div class="mb-4 text-sm font-light text-gray-500 dark:text-gray-400">
                    <img :id="`second-${id}`" src="" alt="Tutor photo" class="w-36 h-36 rounded-lg mx-auto mb-2">
...
onMounted(() => {
    var image = "/src/assets/credits/" + props.picture;
